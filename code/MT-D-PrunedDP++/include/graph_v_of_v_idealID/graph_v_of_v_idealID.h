...
g++ -std=c++17 -I/home/boost_1_75_0 -I/root/include try.cpp -lpthread -O3 -o A
./A
rm A
...
inline void graph_v_of_v_idealID_add_edge(graph_v_of_v_idealID& g, int e1, int e2, int ec) {
...
inline void graph_v_of_v_idealID_remove_all_adjacent_edges(graph_v_of_v_idealID& g, int v) {
	...
	std::vector<std::pair<int, int>>().swap(g[v]);
